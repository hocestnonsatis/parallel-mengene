...
impl PipelineCoordinator {
    ...
    pub fn determine_strategy(&self, file_size: u64) -> crate::parallel_pipeline::CompressionStrategy {
    ...
    pub async fn combine_chunks(&self, compressed_chunks: &[Vec<u8>], output_path: &Path) -> Result<()> {
    ...
    pub fn calculate_optimal_workers(&self, file_size: u64) -> usize {
        let num_chunks = (file_size as usize + self.chunk_size_bytes - 1) / self.chunk_size_bytes;
